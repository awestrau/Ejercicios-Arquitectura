...
## Slide 3: Objetivo del Trabajo (Westra)
...
## Slide 5: Spotify en Cifras (Westra)
...
## Slide 7: Patrones Arquitectónicos (Daniel)
...
## Slide 8: Tecnologías Principales — Lenguajes (Daniel)
...
## Slide 9: Tecnologías — Infraestructura (Daniel)
...
## Slide 10: Tecnologías — Almacenamiento y Mensajería (Daniel)
...
## Slide 13: Streaming y Publicidad (Daniel)
...
## Slide 14: Social, Auth y Plataforma de Datos (Daniel)
...
## Slide 15: Content Platform (Daniel)
...
## Slide 17: Manejo de Datos (Erick)
...
## Slide 19: Escalabilidad y Disponibilidad (Erick)
...
## Slide 20: Diagrama de Arquitectura (Erick)
...
## Slide 21: Diagrama de Arquitectura (2) (Erick)
...
## Slide 22: ADR-1: Monolito → Microservicios — Decisiones Arquitectónicas Clave (Erick)
...
## Slide 23: ADR-2: Google Cloud | ADR-3: Cassandra — Decisiones Arquitectónicas Clave (Erick)
...
## Slide 24: ADR-4: Apache Kafka | ADR-5: Apollo GraphQL — Decisiones Arquitectónicas Clave (Erick)
...
## Slide 25: ADR-6: Modelo de Squads | ADR-7: Backstage — Decisiones Arquitectónicas Clave (Erick)
...
## Slide 26: ADR-8: Caché Distribuida (Redis + Memcached) — Decisiones Arquitectónicas Clave (Erick)
...
## Slide 31: Coincidencias Clave (Michael)
...
## Slide 32: Diferencias Significativas (Michael)
...
## Slide 35: Impacto de la IA (Charlie)
...
## Slide 37: Nuevas Responsabilidades (Charlie)
...
## Slide 38: Habilidades a Desarrollar (Charlie)
...
## Slide 39: Automatización vs. Criterio Humano (Charlie)
...
## Slide 41: Riesgos y Oportunidades (Charlie)
...
## Slide 43: Síntesis del Trabajo (Westra)
